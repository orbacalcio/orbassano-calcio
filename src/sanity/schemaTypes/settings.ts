...
export const settings = defineType({
  ...
  fieldsets: [
    ...
    // NB: i fieldset Academy sono stati spostati 2026-06-09 in 4
    // documenti singleton dedicati (academyHome, academyIscriviti,
    // academyProgramma, academyInformazioni). Vedi schemaTypes/academy*.ts.
  ],
  fields: [
    defineField({
      name: "siteTitle",
