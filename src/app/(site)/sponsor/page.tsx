          ...
          <div className="flex max-w-3xl flex-col gap-4">
            ...
            <div className="mt-2 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="bg-brand-red btn-wow-sweep text-brand-white hover:bg-brand-blue focus-visible:outline-brand-gold inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-xs font-semibold tracking-[0.05em] uppercase transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-offset-4"
              >
                Diventa sponsor
