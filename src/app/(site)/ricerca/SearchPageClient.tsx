      ...
      <header className="flex flex-col gap-4">
        ...
        >
          ...
          <button
            ...
            className="bg-brand-red btn-wow-sweep text-brand-white hover:bg-brand-blue focus-visible:outline-brand-gold shrink-0 rounded-full px-5 py-2 text-xs font-bold tracking-[0.1em] uppercase transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Cerca
          </button>
        </form>
