 ...
 * 4. Filter: _type in ['sponsor', 'news', 'match', 'player', 'team', 'heroSlide', 'settings', 'clubOfficial', 'facility', 'timelineEvent', 'club', 'competition', 'opponent', 'riferimentiOperativi', 'trasparenza5x1000', 'gallery']
