...
export async function Hero() {
  ...
  return (
    <section
      ...
      // -mt-[111px] xl:-mt-[78px]: annulla il padding-top del main
      // (AppShell pt-[111px] xl:pt-[78px]) cosi' l'hero parte da Y=0
      ...
      // Lo shell desktop (sidebar+topbar) vive da xl (≥1280): sotto,
      // tablet e telefoni usano la MobileTopbar (111px), quindi il
      // negative margin desktop scatta solo a xl.
      ...
      className="relative -mt-[111px] flex min-h-dvh flex-col justify-center overflow-hidden xl:-mt-[78px]"
    >
      {hasSlides ? (
