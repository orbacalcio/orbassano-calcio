      ...
      <AnimatePresence>
        {view === "hidden" && hasStoredConsent && (
          <motion.button
            ...
            className="group border-ink-mid/40 hover:bg-ink-hi hover:border-ink-hi focus-visible:outline-brand-gold fixed z-[55] hidden h-10 w-10 items-center justify-center rounded-full border transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 lg:flex lg:!right-[20px] lg:!bottom-7"
          >
            <SoccerBallIcon />
          </motion.button>
        )}
...
/**
 * Pallone da calcio — SVG freeware fornito dall'utente (cerchio nero
 * + pattern bianco classico esagono+pentagono). ViewBox 194x194,
 * renderizzato a 20px nel button. fill espliciti #000/#fff: e'
 * un'icona simbolica universalmente riconoscibile, NON un elemento
 * di UI navy/oro (la regola "mai nero/bianco puro" del brand vale
 * per superfici e testi, non per icone iconiche).
 */
