      ...
      <AnimatePresence>
        {view === "hidden" && hasStoredConsent && (
          <motion.button
            ...
            className="group border-ink-mid/40 hover:bg-ink-hi hover:border-ink-hi focus-visible:outline-brand-gold fixed z-[55] hidden h-10 w-10 items-center justify-center rounded-full border transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 xl:flex xl:!right-[20px] xl:!bottom-7"
          >
            <SoccerBallIcon />
          </motion.button>
        )}
