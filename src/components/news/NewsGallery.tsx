        ...
        {valid.map((img, i) => (
          <li key={img.url ?? `gallery-${i}`} className={slotPlacement(i)}>
            ...
            >
              ...
              <div
                aria-hidden
                className="from-dark-bg-0/30 absolute inset-0 bg-gradient-to-t to-transparent opacity-0 transition-opacity group-hover:opacity-100"
              />
              <span
                aria-hidden
                className="bg-dark-bg-0/70 text-dark-ink-hi absolute right-3 bottom-3 inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[11px] font-semibold tracking-[0.1em] uppercase opacity-0 backdrop-blur-md transition-opacity group-hover:opacity-100"
              >
                <ZoomIn size={12} />
                Zoom
              </span>
              {img.caption && (
                <span className="bg-dark-bg-0/80 text-dark-ink-hi absolute bottom-0 left-0 right-0 px-3 py-2 text-xs leading-snug backdrop-blur-md">
                  {img.caption}
                </span>
              )}
            </button>
      ...
      <AnimatePresence>
        {active && (
          <motion.div
            ...
            className="bg-dark-bg-0/95 fixed inset-0 flex flex-col"
          ...
          >
            <header className="flex items-center justify-between p-4">
              <span className="text-dark-ink-mid font-mono text-xs tracking-[0.15em] uppercase">
              ...
              <button
                ...
                className="text-dark-ink-hi hover:text-brand-gold focus-visible:outline-brand-gold flex h-10 w-10 items-center justify-center rounded-full transition-colors focus-visible:outline-2 focus-visible:outline-offset-2"
              >
            ...
            >
              {valid.length > 1 && (
                <button
                  ...
                  className="bg-dark-bg-1/80 text-dark-ink-hi hover:bg-dark-bg-2 focus-visible:outline-brand-gold absolute left-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full backdrop-blur-md transition-colors focus-visible:outline-2 lg:left-6"
                >
              ...
              >
                ...
                {active.caption && (
                  <p className="text-dark-ink-mid mt-4 max-w-2xl text-center text-sm leading-relaxed">
                    {active.caption}
                  </p>
                )}
              </motion.div>
              ...
              {valid.length > 1 && (
                <button
                  ...
                  className="bg-dark-bg-1/80 text-dark-ink-hi hover:bg-dark-bg-2 focus-visible:outline-brand-gold absolute right-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full backdrop-blur-md transition-colors focus-visible:outline-2 lg:right-6"
                >
